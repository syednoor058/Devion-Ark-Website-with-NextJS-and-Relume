...
export const PortfolioBentoGrid = ({ className, expanded }) => {
  return (
        ...
        <>
          <div className="w-full flex flex-col lg:flex-row gap-3">
            ...
            <div className="w-full lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="flex flex-col rounded-[15px] border p-4 md:p-5 xl:p-7 bg-gradient-to-b from-zinc-900 to-black">
                ...
                <p className="text-sm mt-1">
                  A laser-targeted Facebook ads campaign that delivered more
                  than expected and satisfied results.
                </p>
                <div className="flex mt-3 xl:mt-5">
                  <SecondaryButton
                    text="View details"
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3">
            ...
            <div className="flex flex-col rounded-[15px] border p-4 md:p-5 xl:p-7 bg-gradient-to-b from-zinc-900 to-black">
              ...
              <p className="text-sm mt-1">
                Full responsive online platform to maintain stores, manage
                orders, and track inventory seamlessly.
              </p>
              <div className="flex mt-3 xl:mt-5">
                <SecondaryButton
                  text="View details"
