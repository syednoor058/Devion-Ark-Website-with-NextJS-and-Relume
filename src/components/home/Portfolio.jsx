  ...
  return (
    ...
    >
      <div className="container relative z-[3]">
        <header className="mx-auto mb-12 max-w-3xl text-center md:mb-18 lg:mb-20 flex flex-col items-center">
          <p className="mb-3 font-semibold md:mb-4 text-accentColor1">
            Portfolio
          </p>
          <h2 className="mb-5 text-3xl font-bold md:mb-6 md:text-4xl lg:text-5xl max-w-2xl text-titleColor">
            Crafting Creative Solutions at All Scales
          </h2>
          <p className="md:text-md">
            From startups to nationwide enterprises, our work speaks for itself.
            We've engineered an intuitive e-commerce platform for sportswear
            brands, boosting sales by 150% through SEO-friendly web development,
            and built a custom CRM system that automated 70% of manual tasks for
            real estate professionals. Our strategic social media campaigns
            transformed a local retailer's online presence, tripling engagement,
            while targeted SEO strategies helped a tech startup dominate Google
            rankings.
          </p>
        </header>
      ...
      <div className="w-[25%] lg:w-[15%] aspect-square absolute z-[1] overflow-hidden top-0 left-0">
        <Image
          src={bgElement}
