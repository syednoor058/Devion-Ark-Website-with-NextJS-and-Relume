    ...
    <section className="overflow-hidden px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mb-12 w-full max-w-lg md:mb-18 lg:mb-20">
          <h2 className="heading-h2 mb-5 font-bold md:mb-6">Client Feedback</h2>
          <p className="text-medium">
            Our custom software transformed our business operations.
          </p>
        </div>
        <Carousel
              ...
              <CarouselItem className="pl-0 lg:basis-1/2 lg:pr-16">
                <div className="mx-auto flex h-full max-w-lg flex-col justify-center">
                  ...
                  <blockquote className="heading-h6 font-bold">
                    "The software solution exceeded our expectations and
                    streamlined our processes efficiently."
                  </blockquote>
