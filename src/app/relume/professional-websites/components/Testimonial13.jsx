        ...
        <div className="grid w-full auto-cols-fr grid-cols-1 items-center justify-center gap-12 md:grid-cols-2 md:gap-10 lg:gap-x-20">
          ...
          <div className="flex flex-col items-start">
            ...
            <blockquote className="heading-h5 font-bold">
              "The website developed by this agency transformed our online
              presence and significantly increased our lead generation. Their
              attention to detail and innovative design truly set them apart!"
            </blockquote>
